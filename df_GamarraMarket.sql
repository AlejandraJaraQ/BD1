...
AND k.constraint_name = 'VENTA_CLIENTE';
...
ALTER TABLE VENTA_DETALLE
    ...
    ON UPDATE CASCADE
    ON DELETE CASCADE
    /* Listar relación entre VENTA_DETALLE y PRENDA */
SELECT 
    i.constraint_name, k.table_name, k.column_name, 
    k.referenced_table_name, k.referenced_column_name
FROM 
...
WHERE i.CONSTRAINT_TYPE = 'FOREIGN KEY' 
AND i.TABLE_SCHEMA = DATABASE()
AND k.constraint_name = 'VENTA_DETALLE_PRENDA';
/* Listar tablas existentes en la base de datos en uso */
SHOW TABLES;
...
ALTER TABLE VENTA_DETALLE
    ...
    ON UPDATE CASCADE
    ON DELETE CASCADE
/* Listar relación entre VENTA_DETALLE y VENTA */
SELECT 
    i.constraint_name, k.table_name, k.column_name, 
    k.referenced_table_name, k.referenced_column_name
FROM 
...
WHERE i.CONSTRAINT_TYPE = 'FOREIGN KEY' 
AND i.TABLE_SCHEMA = DATABASE()
AND k.constraint_name = 'VENTA_DETALLE_VENTA';
...
ALTER TABLE VENTA
    ...
    ON UPDATE CASCADE
    ON DELETE CASCADE
/* Listar relación entre VENTA_VENDEDOR */
SELECT 
    i.constraint_name, k.table_name, k.column_name, 
    k.referenced_table_name, k.referenced_column_name
FROM 
...
WHERE i.CONSTRAINT_TYPE = 'FOREIGN KEY' 
AND i.TABLE_SCHEMA = DATABASE()
AND k.constraint_name = 'VENTA_VENDEDOR';